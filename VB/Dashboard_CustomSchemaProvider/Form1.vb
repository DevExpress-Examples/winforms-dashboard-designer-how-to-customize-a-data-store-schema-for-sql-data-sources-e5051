...
Namespace Dashboard_CustomSchemaProvider
    Partial Public Class Form1
        ...
        Private Class CustomDBSchemaProvider
            ...
            Public Function GetSchema(ByVal connection As SqlDataConnection) As DBSchema _
                ...
                If cp IsNot Nothing AndAlso cp.FileName = "..\..\Data\nwind.mdb" Then
                    ...
                    Dim foreignKey As New DBForeignKey({categoryIdColumn2},
            ...
            Public Shared Function CreatePrimaryKeys(ByVal ParamArray names() As String) _
                As StringCollection
