...
Namespace Dashboard_CustomSchemaProvider
	Partial Public Class Form1
		...
		Private Class CustomDBSchemaProvider
            ...
            Public Function GetSchema(ByVal dataConnection As DataConnection, _
                ...
                Else
                    Return New DBSchemaProvider().GetSchema(dataConnection, tableList)
                End If
            End Function
            Public Function GetSchema(ByVal dataConnection As DataConnection) As DBSchema _
                Implements IDBSchemaProvider.GetSchema
                Dim cp = TryCast(dataConnection.ConnectionParameters, Access97ConnectionParameters)
                If cp IsNot Nothing AndAlso cp.FileName = "..\..\Data\nwind.mdb" Then
                ...
                Else
                    Return New DBSchemaProvider().GetSchema(dataConnection)
                End If
            End Function
        End Class
	End Class
